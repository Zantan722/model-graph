...
const story={id:'same-id',title:'Flow',diagram:'sequence',status:'ready',source};
const report={id:'run1',themes:[{id:'one',title:'One',views:[story,{...story,id:'pending',status:'generating'},{...story,id:'failed',status:'failed'},{...story,id:'invalid',source:'@startuml\n!include /bad\n@enduml'}]},{id:'two',title:'Two',views:[story]}]};
