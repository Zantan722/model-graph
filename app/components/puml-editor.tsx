...
import { Braces, Download, Upload, X, Check, ArrowRight } from 'lucide-react';
...
export function PumlEditor({initialSource,onClose,onApply}:{initialSource:string;onClose:()=>void;onApply:(result:PumlResult)=>void}){
 ...
 const [result,setResult]=useState<PumlResult|null>(null),[fileError,setFileError]=useState('');
