...
for (const name of ['main.cjs', 'protocol.cjs', 'preload.cjs', 'ai.cjs', 'ai-ipc.cjs', 'stories.cjs', 'repo-analysis.cjs', 'report-store.cjs', 'views.cjs', 'generate-views.cjs', 'puml-files.cjs']) copyFileSync(`${root}/desktop/${name}`, `${root}/desktop-app/${name}`);
